_.each(hierarchyData, function(hierarchyData) {
  ...
  function down(d, i) {
    ...
    svg.select(".step-background").data([d]).transition().duration(end); d.index = i;
  }
  ...
  function up(d) {
    ...
    svg.select(".step-background").data([d.parent]).transition().duration(end);;
  }
